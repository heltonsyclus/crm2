      ...
      },
      {
        ...
        cards: [
          ...
          },
          {
            ...
            width: "31vw",
            height: "40",
            link_item: "https://crm.syclus.com.br/atividades/<id_grupo>",
            conteudo_card: {
              body_grupo: "bodyOcorrenciaPorAtividade",
              filtro_sql_grupo:
                "where o.ds_status = 'P' and o.cd_tipo_ocorrencia = 1",
              body_item: "bodyOcorrenciaPorColaborador",
              filtro_sql_item:
                "where o.ds_status = 'P' and o.cd_tipo_ocorrencia = 1 and a.cd_atividade = <id_grupo>"
            }
          },
          {
            card: "Colaborador",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              filtro_sql_grupo:
                "where a.ds_status = 'F' and ag.cd_tag = 140 and a.cd_responsavel = <id_principal>",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and ag.cd_tag = 140 and a.cd_responsavel = <id_principal> and cast(a.dt_previsao as date) = dateadd(day, <id_grupo>, cast('01/01/1970' as date))"
            }
          }
        ]
      },
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_prioridade = <id_grupo>"
            }
          }
        ]
      },
        ...
        cards: [
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorWorkflow",
              filtro_sql_grupo:
                "where a.ds_status in ('P', 'F') and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorWorkflow",
              filtro_sql_grupo:
                "where a.ds_status = 'P' and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28)",
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_workflow = <id_grupo>"
            }
          },
          {
            card: "Distribuição do Tempo",
            ...
            conteudo_card: {
              body_grupo: "bodyOcorrenciaPorWorkflow",
              filtro_sql_grupo:
                "where o.ds_status <> 'C' and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(o.dt_ocorrencia as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and o.cd_tipo_ocorrencia = 1",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorWorkflow",
              filtro_sql_grupo:
                "where a.ds_status in ('P', 'F') and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_emissao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorWorkflow",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorWorkflow",
              filtro_sql_grupo:
                "where a.ds_status in ('P', 'F') and a.cd_workflow in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_emissao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorWorkflow",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_workflow in (35, 36, 37, 38, 39, 40, 41, 49) and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_workflow = 36 and a.cd_prioridade = <id_grupo>"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_workflow = 37 and a.cd_prioridade = <id_grupo>"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_workflow = 38 and a.cd_prioridade = <id_grupo>"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_workflow = 39 and a.cd_prioridade = <id_grupo>"
            }
          },
          {
            card: "Distribuição do Tempo",
            ...
            conteudo_card: {
              body_grupo: "bodyOcorrenciaPorColaborador",
              filtro_sql_grupo:
                "where o.ds_status <> 'C' and cast(o.dt_ocorrencia as date) = current_date and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.cd_workflow = 39 and o.cd_tipo_ocorrencia = 1",
              body_item: "",
              filtro_sql_item: ""
            }
          },
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorSituacao",
              filtro_sql_grupo:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade = 3 and a.qt_colaborador_ativo > 0",
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade = 3 and a.qt_colaborador_ativo > 0 and a.cd_situacao = <id_grupo>"
            }
          },
          {
            card: "Situação",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status = 'P' and cast(a.dt_previsao as date) = current_date and a.cd_tipo_atividade = 3 and a.cd_responsavel = <id_grupo>"
            }
          },
          {
            card: "Ocorrências",
            ...
            conteudo_card: {
              body_grupo: "bodyOcorrenciaPorColaborador",
              filtro_sql_grupo:
                "where o.ds_status <> 'C' and cast(o.dt_ocorrencia as date) = current_date and a.cd_tipo_atividade = 3 and o.cd_tipo_ocorrencia = 1",
              body_item: "",
              filtro_sql_item: ""
            }
          }
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyOcorrenciaPorWorkflow",
              filtro_sql_grupo:
                "where o.ds_status <> 'C' and a.cd_workflow not in (35, 36, 37, 38, 39, 40, 41, 49) and cast(o.dt_ocorrencia as date) = current_date and a.cd_tipo_atividade = 3 and o.cd_tipo_ocorrencia = 1",
              body_item: "",
              filtro_sql_item: ""
            }
          },
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyOcorrenciaPorWorkflow",
              filtro_sql_grupo:
                "where o.ds_status <> 'C' and a.cd_workflow in (35, 36, 37, 38, 39, 40, 41, 49) and cast(o.dt_ocorrencia as date) = current_date and a.cd_tipo_atividade = 3 and o.cd_tipo_ocorrencia = 1",
              body_item: "",
              filtro_sql_item: ""
            }
          },
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (94, 95, 96, 97, 163) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (94, 95, 96, 97, 163) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date) and ag.cd_tag = <id_grupo>"
            }
          },
          {
            card: "Indicação",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (249, 250, 251, 355) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (249, 250, 251, 355) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date) and ag.cd_tag = <id_grupo>"
            }
          },
          {
            card: "Segmento",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (88, 89, 186, 187) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (88, 89, 186, 187) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date) and ag.cd_tag = <id_grupo>"
            }
          },
          {
            card: "Outras Tags",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag not in (94, 95, 96, 97, 163, 88, 89, 186, 187, 249, 250, 251, 355) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag not in (94, 95, 96, 97, 163, 88, 89, 186, 187, 249, 250, 251, 355) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date) and ag.cd_tag = <id_grupo>"
            }
          }
        ]
      },
        ...
        cards: [
          {
            ...
            link_item: "https://crm.syclus.com.br/atividades/<id_item>",
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorMesAno",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag = 163",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag = 163 and cast(extract(year from a.dt_previsao)||lpad(extract(month from a.dt_previsao), 2, '0') as integer) = <id_grupo>"
            }
          },
          {
            card: "Encerrados",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorMesAno",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (94, 95, 96, 97)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              ...
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 1 and ag.cd_tag in (94, 95, 96, 97) and cast(extract(year from a.dt_previsao)||lpad(extract(month from a.dt_previsao), 2, '0') as integer) = <id_grupo>"
            }
          }
        ]
      }
        ...
        cards: [
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavelTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 2 and ag.cd_tag in (140, 141, 367) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
        ...
        cards: [
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavelTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag in (140, 141, 367) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavel",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140, 367)) = 0 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 3 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140, 367)) = 0 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date) and a.cd_responsavel = <id_grupo>"
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorData",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140, 367)) = 0 and a.dt_previsao >= current_date -30",
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 3 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140, 367)) = 0 and cast(a.dt_previsao as date) = dateadd(day, <id_grupo>, cast('01/01/1970' as date))"
            }
          },
          {
            card: "Sem Classificacao (Mês Atual)",
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorData",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 140 and a.dt_previsao >= current_date -30",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 140 and cast(a.dt_previsao as date) = dateadd(day, <id_grupo>, cast('01/01/1970' as date))"
            }
          },
          {
            card: "Inconforme (Mês Atual)",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavel",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 140 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 140 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date) and a.cd_responsavel = <id_grupo>"
            }
          },
          {
            card: "Verificada",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorData",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 367 and a.dt_previsao >= current_date -30",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 367 and cast(a.dt_previsao as date) = dateadd(day, <id_grupo>, cast('01/01/1970' as date))"
            }
          },
          {
            card: "Verificada (Mês Atual)",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavel",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 367 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorData",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 141 and a.dt_previsao >= current_date -30",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 141 and cast(a.dt_previsao as date) = dateadd(day, <id_grupo>, cast('01/01/1970' as date))"
            }
          },
          {
            card: "Conforme (Mês Atual)",
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavel",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 3 and ag.cd_tag = 141 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "",
              filtro_sql_item: ""
            }
          }
