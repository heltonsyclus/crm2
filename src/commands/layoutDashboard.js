      ...
      },
      {
        ...
        cards: [
          ...
          /*{
            ...
            width: "31vw",
            height: "40",
            link_grupo: "https://crm.syclus.com.br/atividades/<id_grupo>",
            link_item: "https://crm.syclus.com.br/atividades/<id_item>",
            conteudo_card: {
          ...
          /*     {
            ...
            conteudo_card: {
              ...
              filtro_sql_grupo:
                "where a.ds_status = 'P' and a.qt_colaborador_ativo > 0"
              //body_grupo: "bodyAtividadePorCliente",
              //filtro_sql_grupo: "where a.ds_status = 'P' and a.qt_colaborador_ativo > 0",
              //body_item: "bodyAtividadeCliente",
              //filtro_sql_item: "where a.ds_status = 'P' and a.qt_colaborador_ativo > 0 and ac.cd_cliente = <id_grupo>"
            }
          },*/
          {
            card: "Worflow",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body: "bodyAtividade",
              filtro_sql:
                "where a.ds_status = 'P' and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.qt_colaborador_ativo > 0"
            }
          },
          {
            card: "Situação",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body: "bodyAtividade",
              filtro_sql:
                "where a.ds_status = 'P' and a.cd_workflow = 35 and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.qt_colaborador_ativo > 0"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body: "bodyAtividade",
              filtro_sql:
                "where a.ds_status = 'P' and a.cd_workflow = 36 and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.qt_colaborador_ativo > 0"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body: "bodyAtividade",
              filtro_sql:
                "where a.ds_status = 'P' and a.cd_workflow = 37 and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.qt_colaborador_ativo > 0"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body: "bodyAtividade",
              filtro_sql:
                "where a.ds_status = 'P' and a.cd_workflow = 38 and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.qt_colaborador_ativo > 0"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          ...
          },
          {
            ...
            conteudo_card: {
              body: "bodyAtividade",
              filtro_sql:
                "where a.ds_status = 'P' and a.cd_workflow = 39 and a.cd_tipo_atividade in (2,15,18,19,20,27,28) and a.qt_colaborador_ativo > 0"
            }
          },
          {
            card: "Distribuição do Tempo",
        ...
        cards: [
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavelTag",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 2 and ag.cd_tag in (140, 141) and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
          {
            ...
            conteudo_card: {
              ...
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 2 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140)) = 0 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadePorData",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 2 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140)) = 0 and a.dt_previsao >= current_date -30",
              body_item: "bodyAtividade",
              filtro_sql_item:
                "where a.ds_status ='F' and a.cd_tipo_atividade = 2 and (select count(ag.cd_tag) from atividade_tag ag where ag.cd_empresa = a.cd_empresa and ag.cd_atividade = a.cd_atividade and ag.cd_tag in (141, 140)) = 0 and cast(a.dt_previsao as date) = dateadd(day, <id_grupo>, cast('01/01/1970' as date))"
            }
          },
          {
            card: "Sem Classificacao (Mês Atual)",
          ...
          },
          {
            ...
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorData",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 2 and ag.cd_tag = 153 and a.dt_previsao >= current_date -30",
              body_item: "bodyAtividadeTag",
              filtro_sql_item:
          ...
          {
            card: "Correção Pendente (Mês Atual)",
            btn_comando: "btn-atualizar",
            tipo_card: "CardGrupoApi",
            width: "46.5vw",
            height: "40",
            conteudo_card: {
              body_grupo: "bodyAtividadeTagPorResponsavel",
              filtro_sql_grupo:
                "where a.ds_status = 'F' and a.cd_tipo_atividade = 2 and ag.cd_tag = 153 and extract(month from a.dt_previsao) = extract(month from current_date) and extract(year from a.dt_previsao) = extract(year from current_date)",
              body_item: "",
              filtro_sql_item: ""
            }
          },
